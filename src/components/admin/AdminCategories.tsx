      ...
      <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={saveOrder}
            disabled={saving}
            className="bg-rose-500 text-white text-sm px-4 py-1.5 rounded-lg hover:bg-rose-600 transition-colors disabled:opacity-50"
          >
            ...
            <li key={cat.id} className="flex items-center gap-4 px-6 py-3 hover:bg-gray-50">
              ...
              <div className="flex items-center gap-1">
                ...
                <input
                  ...
                  className="w-16 text-sm text-center border border-gray-200 rounded-md px-2 py-1 focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                />
              </div>
            </li>
          ))}

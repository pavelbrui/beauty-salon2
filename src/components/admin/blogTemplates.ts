...
export const blogTemplates: BlogPostTemplate[] = [
  {
    ...
    excerpt: 'Dowiedz się więcej o makijażu permanentnym w studio Anna Nowak w Białymstoku.',
    excerpt_en: 'Learn more about permanent makeup at Anna Nowak salon in Bialystok.',
    ...
    content_blocks: [
      ...
      { id: 'tpl1-5', type: 'text', text: 'Zapraszamy do studia Anna Nowak przy ul. Młynowej 46 w Białymstoku!', text_en: 'Visit Anna Nowak salon at ul. Mlynowa 46 in Bialystok!', text_ru: 'Приглашаем в салон Катажина Бруй по ул. Млынова 46 в Белостоке!' },
    ] as ContentBlock[],
  },
  {
  ...
  },
  {
    ...
    category: 'tips',
    excerpt: 'Praktyczne porady kosmetyczne od specjalistek studia Anna Nowak.',
    excerpt_en: 'Practical beauty tips from Anna Nowak salon specialists.',

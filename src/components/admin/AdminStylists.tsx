        ...
        {stylists.map((stylist) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-rose-600">{stylist.role}</p>
              <div className="mt-2 flex flex-wrap gap-2">
                {stylist.specialties.map((specialty) => (
                  <span
                    key={specialty}
                    className="px-2 py-1 bg-rose-100 text-rose-800 rounded-full text-sm"
                  >
                    {specialty}
                  </span>
                ))}
            ...
            >
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">
                  ...
                  {translating && <span className="ml-2 text-xs text-rose-500 animate-pulse">tłumaczenie...</span>}
                </label>
                <input
                  type="text"
                  value={roleEn}
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-rose-500 text-white rounded-md hover:bg-rose-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {saving && (
                    <svg className="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24">
                      <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />

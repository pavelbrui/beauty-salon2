    ...
    <div className="space-y-3">
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="rounded-md border-gray-300 text-sm py-1 px-2 focus:border-brand focus:ring-brand"
        >
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          <label className={`cursor-pointer px-4 py-2 rounded-md text-sm font-medium transition-colors ${
            uploading ? 'bg-gray-300 cursor-not-allowed' : 'bg-brand text-white hover:bg-brand-600'
          }`}>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`px-3 py-1 text-xs rounded-md transition-colors ${
              b.style === 'bullet' ? 'bg-brand text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
            }`}
          >
            • Punkty
          </button>
          <button
            ...
            className={`px-3 py-1 text-xs rounded-md transition-colors ${
              b.style === 'check' ? 'bg-brand text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
            }`}
          >
            ✓ Checklist
          </button>

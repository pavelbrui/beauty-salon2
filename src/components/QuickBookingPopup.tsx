        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[85vh] flex flex-col">
          ...
          <div className="p-4 border-b border-gray-100 flex items-center gap-3 flex-shrink-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-rose-600 capitalize">{dateLabel}</p>
            </div>
            <button
              onClick={onClose}
              className="p-1.5 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-gray-600 transition-colors"
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-rose-300 focus:border-rose-400 outline-none"
                  />
                </div>
                    ...
                    <div className="space-y-1.5">
                      {categoryServices.map((s) => (
                        <button
                          ...
                          className="w-full text-left p-3 rounded-xl border border-gray-100 hover:border-rose-300 hover:bg-rose-50/50 transition-all group"
                        >
                          <div className="flex items-center justify-between">
                            <span className="font-medium text-gray-900 text-sm group-hover:text-rose-700 transition-colors">
